...
{"fatom",     "I",   "s,t"    ,  MATCH_FATOM , MASK_FATOM, match_opcode, 0}, // fill atom instruction
{"fatom_select",     "I",   "s,t"    ,  MATCH_FATOM_SELECT , MASK_FATOM_SELECT , match_opcode, 0}, // fill atom instruction
{"fatom_load",     "I",   "s,t"    ,  MATCH_FATOM_LOAD , MASK_FATOM_LOAD , match_opcode, 0}, // fill atom instruction
{"atom_activate"  , "I", "u",   MATCH_ATOM_ACTIVATE, MASK_ATOM_ACTIVATE, match_opcode, 0},
{"atom_deactivate", "I", "u",   MATCH_ATOM_DEACTIVATE, MASK_ATOM_DEACTIVATE, match_opcode, 0},
{"atom_status"    , "I", "d,s", MATCH_ATOM_STATUS, MASK_ATOM_STATUS, match_opcode, 0},
{"ld_acr"         , "I", "d,s", MATCH_LD_ACR, MASK_LD_ACR, match_opcode, 0},
{"st_acr"         , "I", "d",   MATCH_ST_ACR, MASK_ST_ACR, match_opcode, 0},
{"atom_map"       , "I", "d,s,t", MATCH_ATOM_MAP, MASK_ATOM_MAP, match_opcode, 0},
{"atom_unmap"     , "I", "d,s", MATCH_ATOM_UNMAP, MASK_ATOM_UNMAP, match_opcode, 0},
{"atom_mstatus"   , "I", "d,s", MATCH_ATOM_MSTATUS, MASK_ATOM_MSTATUS, match_opcode, 0},
{"atom_m_init"    , "I", "d,s", MATCH_ATOM_M_INIT, MASK_ATOM_M_INIT, match_opcode, 0},

{"amu_clear_acr"   , "I", "",      MATCH_AMU_CLEAR_ACR,    MASK_AMU_CLEAR_ACR,    match_opcode, 0},
{"amu_write_acr"   , "I", "t",     MATCH_AMU_WRITE_ACR,    MASK_AMU_WRITE_ACR,    match_opcode, 0},
{"amu_read_acr"    , "I", "d",     MATCH_AMU_READ_ACR,     MASK_AMU_READ_ACR,     match_opcode, 0},
{"amu_read_len"    , "I", "d",     MATCH_AMU_READ_LEN,     MASK_AMU_READ_LEN,     match_opcode, 0},
{"amu_write_len"   , "I", "t",     MATCH_AMU_WRITE_LEN,    MASK_AMU_WRITE_LEN,    match_opcode, 0},
{"amu_map"         , "I", "s,t",   MATCH_AMU_MAP,          MASK_AMU_MAP,          match_opcode, 0},
{"amu_unmap"       , "I", "s,t",   MATCH_AMU_UNMAP,        MASK_AMU_UNMAP,        match_opcode, 0},
{"ast_activate"    , "I", "t",     MATCH_AST_ACTIVATE,     MASK_AST_ACTIVATE,     match_opcode, 0},
{"ast_deactivate"  , "I", "t",     MATCH_AST_DEACTIVATE,   MASK_AST_DEACTIVATE,   match_opcode, 0},
{"ast_status"      , "I", "d,t",   MATCH_AST_STATUS,       MASK_AST_STATUS,       match_opcode, 0},
{"amu_read_stride" , "I", "d",     MATCH_AMU_READ_STRIDE,  MASK_AMU_READ_STRIDE,  match_opcode, 0},
{"amu_write_stride", "I", "t",     MATCH_AMU_WRITE_STRIDE, MASK_AMU_WRITE_STRIDE, match_opcode, 0},
{"amu_read_rowcnt" , "I", "d",     MATCH_AMU_READ_ROWCNT,  MASK_AMU_READ_ROWCNT,  match_opcode, 0},
{"amu_write_rowcnt", "I", "t",     MATCH_AMU_WRITE_ROWCNT, MASK_AMU_WRITE_ROWCNT, match_opcode, 0},
{"amu_map_2d"      , "I", "s,t",   MATCH_AMU_MAP_2D,       MASK_AMU_MAP_2D,       match_opcode, 0},
{"amu_unmap_2d"    , "I", "s,t",   MATCH_AMU_UNMAP_2D,     MASK_AMU_UNMAP_2D,     match_opcode, 0},
{"bc_atom_sel"     , "I", "s,t",   MATCH_BC_ATOM_SEL,      MASK_BC_ATOM_SEL,      match_opcode, 0},
//------------------------------------------------------------------------------------------------------------------------------- /////
