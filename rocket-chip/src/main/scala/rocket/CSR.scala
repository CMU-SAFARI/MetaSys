...
class CSRFile(perfEventSets: EventSets = new EventSets(Seq()))(implicit p: Parameters) extends CoreModule()(p)
  ...
  //printf("read_mip:0x%x reg_mie:0x%x Pending:0x%x, d_int:0x%x m_int:0x%x s_int:0x%x anyInt:%d Cause:0x%x\n",read_mip, reg_mie, pending_interrupts, d_interrupts, m_interrupts, s_interrupts,anyInterrupt, interruptCause)
